...
public class UserService {
    ...
    public User createUser(String username, String password, String email,
                          String firstName, String lastName, String phone,String balance, Set<String> roleNames) {
    ...
    public User updateUser(String username,String username1, String email, String firstName,
        ...
        if(username1!=null) {user.setUsername(username1);}
    ...
    // Check if user can withdraw (compare balance)
    public boolean canWithdraw(String username, Double amount) {
        Double balance = userRepository.getBalanceByUsername(username);
